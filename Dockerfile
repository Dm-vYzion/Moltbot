...
CMD ["sh", "-c", "node $(find node_modules/moltbot -name '*.js' -o -name '*.mjs' | grep -E 'index|main|moltbot' | head -n 1) standalone --port 18789 --host 0.0.0.0 --provider discord --model deepseek/deepseek-r1:free --debug --force"]